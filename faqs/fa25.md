...
course:
    ...
    edstem: TBD
    edstem_join: na
    website: https://data101.org/fa25
    logistics_ta: TBD
    repo: TBD
    comms_ta: TBD
    head_ta: TBD
    ...
    room: Lewis Hall 100
    time: Tuesday and Thursday 2-3.30
    discussion_time: TBD
    classes_page: https://cdss.berkeley.edu/classes-enrollment-info

---

# Frequently Asked Questions for {{page.course.current_semester}} Data 101/CS 187
{: .no_toc }
...
Class meets in {{page.course.room}}, **{{page.course.time}}.** The course will be synchronous, but will also be recorded. 

In the past students have found that the best way to engage with the material is in-person. We expect that in-class attendance will drop enough after the first few lectures so you should be able to comfortably attend class if you choose to.

You will be expected to keep up with the lecture material.

No time conflicts are permitted---this is because we don't plan to give alternate exams.
...
Here: [{{page.course.website}}]({{page.course.website}}). The schedule is tentative. 
...
Course staff don't manage enrollment or capacity, so please don't direct such questions to us. 
...
-->
## I have taken/am taking CS 186. Can I still enroll in Data 101/CS 187?
Yes. 
...
The official prerequisites _are being strictly enforced_.  

On the data science front, decisions on any requests for exceptions to this policy are being made by Data Science advisors. To request an exception see the [Data Science Courses Enrollments page]({{page.course.classes_page}}).  <b><i>Do NOT email instructors about this</i></b>; we do not make these decisions.
...
All applications for Academic Student Employee positions are managed centrally; you can find all the details here: [Joining Data Course Staff](https://data.berkeley.edu/academics/undergraduate-programs/courses/joining-data-course-staff). 


## Who do I contact if I have further questions? How do I email the instruction team?

Please e-mail [{{page.course.email}}](mailto:{{page.course.email}}) and a member of the course staff will get back to you.
